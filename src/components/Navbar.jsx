  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl shadow-lg px-6 py-4 flex flex-wrap gap-4 justify-between items-center border-b border-orange-100">
      <Link to={homePath} className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-orange-600 leading-none">KLH Smart Canteen</h1>
          <p className="text-xs font-bold text-gray-500">QueueLess Campus Ordering</p>
        </div>
      </Link>
